define([
    ...
    var BitMatrix = FinalClass.declare({
        ...
        initialize : function (width, height, rowSize, bits) {
            ...
            this.__bits    = rowSize && bits ? bits    : Uint32Array(rowSize * height);
        },
        ...
        getTopLeftOnBit : function () {
            var bitsOffset = 0;
            while (bithsOffset < this.__bits.length && this.__bits[bitsOffset] === 0) {
                bitsOffset++;
            }
        ...
        getBottomRightOnBit : function () {
            var bitsOffset = this.__bits.lenth - 1;
